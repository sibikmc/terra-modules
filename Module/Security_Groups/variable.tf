...
variable "ingress_rules" {
  ...
  type        = list(string)
  default     = ["rest_port-ssl_rest_port","capi_port-ssl_capi_port","epmd","query_port-ssl_query_port","fts_http_port-fts_ssl_port","cbas_http_port-cbas_ssl_port","eventing_http_port-eventing_ssl_port","backup_http_port-backup_ssl_port","indexer_admin_port","indexer_scan_port","indexer_http_port","indexer_https_port","indexer_stinit_port","indexer_stcatchup_port","indexer_stmaint_port","cbas_admin_port","cbas_cc_http_port","cbas_cc_cluster_port","cbas_cc_client_port","cbas_console_port","cbas_cluster_port","cbas_data_port","cbas_result_port","cbas_messaging_port","cbas_auth_port","cbas_replication_port","cbas_metadata_port","cbas_metadata_callback_port","prometheus_http_port","backup_grpc_port","fts_grpc_port-fts_grpc_ssl_port","eventing_debug_port","xdcr_rest_port","projector_port","memcached_dedicated_port-memcached_dedicated_ssl_port","memcached_port-memcached_ssl_port","memcached_prometheus","cluster-management-exchange-1","cluster-management-exchange-2","cluster-management-exchange-3"]
}
